...
| **20時** | 夜の振り返り — 1日の主要ニュースを一問一答20問でおさらい | 1本の長文ポスト（朝のブリーフィングと同じQ&A形式） |
...
> 💡 **起動時刻を毎時13分にしている理由**: 毎時ちょうど0分はGitHub全体で最も混雑するタイミングで、起動そのものが間引かれやすいことが実測（平均108分間隔＝ほぼ半数の回が未起動）で分かりました。あえて0分・30分を避けて13分にすることで、起動の間引きを減らしています。
